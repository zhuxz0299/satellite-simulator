...
file_no_runtime = 'backup/no_runtime3/449380000-energy-system.csv'
file_no_scheduling = 'backup/no_scheduling2/449380000-energy-system.csv'
file_space_only = 'backup/space_only2/449380000-energy-system.csv'
file_space_exit = 'backup/space-exit8/449380000-energy-system.csv'
file_target_fuse = 'backup/target_fuse4/449380000-energy-system.csv'
...
for label, group in combined_data.groupby('source'):
    plt.plot(group['date_time'], group['solar_array_ampere'], label=label)

plt.xlabel('Time')
plt.ylabel('Solar Array Ampere')
plt.title('Solar Array Ampere Over Time')
plt.legend()
plt.xticks(rotation=45)
plt.tight_layout()
plt.show()
plt.savefig("image/solar_array_ampere_coulomb.png")