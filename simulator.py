...
def read_data_from_config():
    global num_step, hour_step, minute_step, second_step, nanosecond_step, total_step_in_sec, date_time, satellite_list, satid_to_sat, satid_to_occlusion_factor, satid_to_solar_array, satid_to_capacitor, satid_to_node_voltage, satid_to_camera, satid_to_computer, satid_to_rx, satid_to_tx, satid_to_sensor, satid_to_thresh_coeff, satid_to_threshold_km, ground_station_list, gndid_to_gnd
    ...
    for satellite in satellite_list:
        ...
        satid_to_computer[sat_id] = Computer()
